    ...
    <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          className="rounded-3xl p-8 sm:p-12 lg:p-16 text-center text-white"
          style={{ background: '#132031' }}
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-white">
            {t('cta_title')}
          </h2>
          <p className="text-base sm:text-lg lg:text-xl mb-8 max-w-2xl mx-auto" style={{ color: 'rgba(255,255,255,0.85)' }}>
            {t('cta_desc')}
          </p>
          <a
