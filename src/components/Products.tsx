...
export const Products: React.FC = () => {
  ...
  return (
    <section id="products" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-10 sm:mb-12"
          style={{ color: '#14181f' }}
        >
          {t('products_title')}
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {cards.map((card, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="rounded-2xl border p-6 sm:p-8 transition-all hover:-translate-y-0.5"
